...
prop.photo.attach(io: File.open(file), filename: 'random.jpg', content_type: 'image/jpg')
file = URI.open("https://source.unsplash.com/random/#{prop.category}")
prop = Prop.create!(category: "accessoire", name: "Overboard de Marty McFly", description: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed ac tempus tellus, vel dignissim metus.", price: 90, movie: retour_futur, user: user2)
file = URI.open("https://source.unsplash.com/random/#{prop.category}")
prop.photo.attach(io: File.open(file), filename: 'random.jpg', content_type: 'image/jpg')
file = URI.open("https://source.unsplash.com/random/#{prop.category}")
